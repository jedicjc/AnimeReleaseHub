    ...
    <>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {filteredAnime.map((item) => (
          ...
          >
            <AnimePoster title={item.title} posterUrl={item.poster_url} />
            ...
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-purple-300">
                Maple Intelligence detected this from anime news signals.
              </p>
            </div>
          </Link>
        ))}
        ...
        {filteredAnime.length === 0 && (
          <div className="col-span-full rounded-3xl border border-white/10 bg-white/10 p-10 text-center">
